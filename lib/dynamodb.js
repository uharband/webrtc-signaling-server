...
class DynamodbApi {
    ...
    async addConnection(connectionId, offer, deviceId, keepalive, connectionStatus, type) {
        ...
        const connection = new this.Connections({"id" : connectionId, "offer": JSON.stringify(offer), "deviceId": deviceId, "keepalive": keepalive, "connectionStatus": connectionStatus, "type": type});
